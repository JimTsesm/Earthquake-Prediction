...
utils.write_dataset(train_inputs, train_labels, DATASET_WRITE_PATH, 'eq2_150_2.csv')

#Read saved dataset
train_labels, train_inputs = utils.read_dataset2(DATASET_WRITE_PATH+'eq2_150_2.csv')
